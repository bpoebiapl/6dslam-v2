...
inline double FeatureDescriptor::distance(FeatureDescriptor * other_descriptor)
{
	...
	else
	{
		...
		else if(type == surf128){	return ((SurfFeatureDescriptor64 * )(this))->distance((SurfFeatureDescriptor64 * )other_descriptor);}
		else if(type == orb){		return ((OrbFeatureDescriptor * )(this))->distance((OrbFeatureDescriptor * )other_descriptor);}
...
inline FeatureDescriptor * FeatureDescriptor::clone(){
	...
	else if	(type == surf128)	{	return ((SurfFeatureDescriptor64 * 	)(this))->clone();}
	else if	(type == orb)		{	return ((OrbFeatureDescriptor * 	)(this))->clone();}
	else if	(type == FPFH)		{	return ((FPFHFeatureDescriptor * 	)(this))->clone();}
	return 0;
}

inline void FeatureDescriptor::update(vector<FeatureDescriptor * > * input){cout<<"no rule for update...\n";}

inline void FeatureDescriptor::store(string path){cout<<"no rule for store...\n";}
