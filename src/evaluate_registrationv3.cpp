...
void test(vector< frame_data * > * all_frames, string dataset, vector<FrameMatcher * > matchers, vector<int> backing)
{
	...
	//printf("Done with setup for results\n");
...
int main(int argc, char **argv)
{
	...
	matchers.push_back(new AICK(200,5,0.3f));
	backing.push_back(30);
	...
	backing.push_back(30);
	matchers.push_back(new BowAICKv2(200,5,0.3f));
	backing.push_back(30);
	matchers.push_back(new BowAICKv2(300,5,0.3f));
	backing.push_back(30);
	matchers.push_back(new BowAICKv2(500,5,0.3f));
	backing.push_back(30);
	matchers.push_back(new BowAICKv2());
...
/*
	...
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf10_bl_025",matchers,backing);
	...
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf100_bl_025",matchers,backing);
	...
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf500_bl_025",matchers,backing);
	...
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf1000_bl_025",matchers,backing);
	...
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf5000_bl_025",matchers,backing);
	
	bow_path = "bow_output/library_1000_1_10_%i.feature.surf";
	words.clear();
	for(int i = 0; i < 1000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf1000_bl_01",matchers,backing);
	...
	for(int i = 0; i < 5000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf5000_bl_01",matchers,backing);
	...
	for(int i = 0; i < 10; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf10_bl_01",matchers,backing);
	
	bow_path = "bow_output/library_100_1_10_%i.feature.surf";
	words.clear();
	for(int i = 0; i < 100; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf100_bl_01",matchers,backing);
	
	bow_path = "bow_output/library_500_1_10_%i.feature.surf";
	words.clear();
	for(int i = 0; i < 500; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf500_bl_01",matchers,backing);
	...
	for(int i = 0; i < 10; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf10_bl_02",matchers,backing);
	
	bow_path = "bow_output/library_100_1_10_%i.feature.surf";
	words.clear();
	for(int i = 0; i < 100; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf100_bl_02",matchers,backing);
	
	bow_path = "bow_output/library_500_1_10_%i.feature.surf";
	words.clear();
	for(int i = 0; i < 500; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf500_bl_02",matchers,backing);
	...
	for(int i = 0; i < 1000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf1000_bl_02",matchers,backing);
	...
	for(int i = 0; i < 5000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf5000_bl_02",matchers,backing);
	...
	for(int i = 0; i < 10; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf10_bl_03",matchers,backing);
	
	bow_path = "bow_output/library_100_1_10_%i.feature.surf";
	words.clear();
	for(int i = 0; i < 100; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf100_bl_03",matchers,backing);
	
	bow_path = "bow_output/library_500_1_10_%i.feature.surf";
	words.clear();
	for(int i = 0; i < 500; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf500_bl_03",matchers,backing);
	...
	for(int i = 0; i < 1000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf1000_bl_03",matchers,backing);
	...
	for(int i = 0; i < 5000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf5000_bl_03",matchers,backing);
	...
	for(int i = 0; i < 10; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf10_bl_04",matchers,backing);
	
	bow_path = "bow_output/library_100_1_10_%i.feature.surf";
	words.clear();
	for(int i = 0; i < 100; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf100_bl_04",matchers,backing);
	
	bow_path = "bow_output/library_500_1_10_%i.feature.surf";
	words.clear();
	for(int i = 0; i < 500; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf500_bl_04",matchers,backing);
	...
	for(int i = 0; i < 1000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf1000_bl_04",matchers,backing);
	
	bow_path = "bow_output/library_5000_1_10_%i.feature.surf";
	words.clear();
	for(int i = 0; i < 5000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKsurf5000_bl_04",matchers,backing);
*/

	float bl = 0.25;
	
	bow_path = "bow_output/library_10_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 10; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new SurfFeatureDescriptor64(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb10_bl_025",matchers,backing);
	
	bow_path = "bow_output/library_100_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 100; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb100_bl_025",matchers,backing);
	
	bow_path = "bow_output/library_500_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 500; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb500_bl_025",matchers,backing);
	...
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb1000_bl_025",matchers,backing);
	
	
	bow_path = "bow_output/library_5000_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 5000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb5000_bl_025",matchers,backing);
	
	bow_path = "bow_output/library_1000_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 1000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb1000_bl_01",matchers,backing);
	...
	for(int i = 0; i < 5000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb5000_bl_01",matchers,backing);
	
	bl = 0.1;
	
	bow_path = "bow_output/library_10_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 10; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb10_bl_01",matchers,backing);
	
	bow_path = "bow_output/library_100_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 100; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb100_bl_01",matchers,backing);
	
	bow_path = "bow_output/library_500_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 500; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb500_bl_01",matchers,backing);
	...
	for(int i = 0; i < 10; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb10_bl_02",matchers,backing);
	
	bow_path = "bow_output/library_100_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 100; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb100_bl_02",matchers,backing);
	
	bow_path = "bow_output/library_500_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 500; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb500_bl_02",matchers,backing);
	...
	for(int i = 0; i < 1000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb1000_bl_02",matchers,backing);
	...
	for(int i = 0; i < 5000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb5000_bl_02",matchers,backing);
	...
	for(int i = 0; i < 10; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb10_bl_03",matchers,backing);
	
	bow_path = "bow_output/library_100_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 100; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb100_bl_03",matchers,backing);
	
	bow_path = "bow_output/library_500_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 500; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb500_bl_03",matchers,backing);
	...
	for(int i = 0; i < 1000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb1000_bl_03",matchers,backing);
	...
	for(int i = 0; i < 5000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb5000_bl_03",matchers,backing);
	...
	for(int i = 0; i < 10; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb10_bl_04",matchers,backing);
	
	bow_path = "bow_output/library_100_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 100; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb100_bl_04",matchers,backing);
	
	bow_path = "bow_output/library_500_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 500; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb500_bl_04",matchers,backing);
	...
	for(int i = 0; i < 1000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb1000_bl_04",matchers,backing);
	
	bow_path = "bow_output/library_5000_1_10_%i.feature.orb";
	words.clear();
	for(int i = 0; i < 5000; i++){char buff[250];sprintf(buff,bow_path.c_str(),i);words.push_back(new OrbFeatureDescriptor(string(buff)));}
	for(int i = 0; i < frames->size(); i++){frames->at(i)->frame->setWords(words,bl);}
	test(frames,"bowAICKorb5000_bl_04",matchers,backing);
