...
bool comparison_Map3DPlanesGraphv3 (Transformation * i,Transformation * j) {
...
Map3DPlanesGraphv3::Map3DPlanesGraphv3(){
...
g2o::SparseOptimizer * Map3DPlanesGraphv3::startNewGraph()
{
...
g2o::VertexSE3 * Map3DPlanesGraphv3::getG2OVertex(RGBDFrame * frame)
{
...
g2o::EdgeSE3 * Map3DPlanesGraphv3::getG2OEdge(Transformation * transformation)
{
...
void Map3DPlanesGraphv3::addFrame(Frame_input * fi){
	//new RGBDFrame(fi,extractor,segmentation);
	addFrame(new RGBDFrame(fi,extractor,segmentation));
}
void Map3DPlanesGraphv3::addFrame(RGBDFrame * frame){
	printf("Map3DPlanesGraphv3::addFrame(RGBDFrame * frame)\n");
...
void Map3DPlanesGraphv3::addTransformation(Transformation * transformation){transformations.push_back(transformation);}
...
void Map3DPlanesGraphv3::setVisualization(boost::shared_ptr<pcl::visualization::PCLVisualizer> view){viewer = view;}

//bool goToNext = false;
//void keyboardEventOccurred (const pcl::visualization::KeyboardEvent &event,void* viewer_void){goToNext = true;}

void Map3DPlanesGraphv3::visualize(){
