...
void FastHessian::getIpoints()
{
  ...
  for (int o = 0; o < octaves; ++o) for (int i = 0; i <= 1; ++i)
  {
    ...
    for (int r = 0; r < t->height; ++r)
    {
      ...
      {
      	float stab = isExtremum(r, c, t, m, b);
        if (stab > 0)
        {
          interpolateExtremum(r, c, t, m, b, stab);
        }
      }
    }
  }
...
float FastHessian::isExtremum(int r, int c, ResponseLayer *t, ResponseLayer *m, ResponseLayer *b)
{
  // bounds check
...
void FastHessian::interpolateExtremum(int r, int c, ResponseLayer *t, ResponseLayer *m, ResponseLayer *b, float stab)
{
